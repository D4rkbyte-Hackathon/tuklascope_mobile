...
const _mockData = {
  ...
  'sections': {
    ...
    'significance': "This site is a symbol of the birth of Christianity in the land. It houses the original cross inside a tindalo wood case to protect it.",
    'history': "The kiosk that houses the cross was built in 1834. The ceiling of the kiosk is painted with a mural depicting the baptism of Rajah Humabon.",
  }
};
...
class _DiscoveryCardsScreenState extends State<DiscoveryCardsScreen> {
                    ...
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          ...
                          Colors.transparent,
                          Color(0xFFFFFDF4), // Fades seamlessly into your app's top background color!
                        ],
                        stops: [0.0, 0.4, 1.0],
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            widget.title, // Uses the title passed from the Teaser Doors!
                            style: const TextStyle(
                              fontSize: 32,
                              fontWeight: FontWeight.w900,
                              color: Color(0xFF0B3C6A), // Dark Blue for contrast
                              height: 1.1,
                            ),
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        _buildTabButton(2, 'Hands-on', Icons.build_circle_outlined),
                      ],
                    ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected ? const Color(0xFFFF9800) : const Color(0xFF0B3C6A).withOpacity(0.2),
              width: 1.5,
            ),
          ),
          child: Column(
  ...
  Widget _buildActiveCard() {
    switch (_selectedIndex) {
      case 0:
        return _buildGlassSection('Quick Fact', (_mockData['sections'] as Map<String, String>)['about']!);
      case 1:
        return _buildGlassSection('Concepts', (_mockData['sections'] as Map<String, String>)['significance']!);
      case 2:
        return _buildGlassSection('Hands-on Project', (_mockData['sections'] as Map<String, String>)['history']!);
      default:
